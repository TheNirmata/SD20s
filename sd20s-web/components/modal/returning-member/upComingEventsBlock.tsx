    ...
    <div className="flex flex-col items-center justify-center text-[#D9D9D9]">
      ...
      <div className="-translate-y-20 flex flex-row">
          <div className="-translate-x-5">
            <Image src={line} alt="line" width={10} />
          </div>
            <div className="flex flex-col">
            {events.map((event, i) =>(
              <Card 
                className="border-2 border-grey border-spacing-x-2 m-4 p-4 w-[250px] h-[120px] bg-default-300 rounded-lg"
                key={i}
                ...
                <div className="-translate-x-7 justify-center items-center -translate-y-5">
                  <button className="bg-white border-white rounded-md text-black w-[230px] h-[15.7px] m-5">
